...
const finalImage = new Image(),
  dataURL = localStorage.getItem("photoStrip");
if (dataURL) {
...
addFishBtn.addEventListener("click", () =>
  addSticker("Assets/fish-photobooth/camerapage/stickers/fish.png"),
);
addOctopusBtn.addEventListener("click", () =>
  addSticker("Assets/fish-photobooth/camerapage/stickers/octopus.png"),
);
...
addAxBtn.addEventListener("click", () =>
  addSticker("Assets/fish-photobooth/camerapage/stickers/axolotl.png"),
);
